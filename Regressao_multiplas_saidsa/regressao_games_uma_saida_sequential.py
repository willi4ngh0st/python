...
regressor.fit(previsores, vendas_global, epochs =200, batch_size = 65)
previsao_vendas_global = regressor.predict(previsores)


regressor_cruzado = KerasRegressor(build_fn=criarRede,
                           epochs = 2000,
                           batch_size = 100
                           )

resultados = cross_val_score(estimator = regressor_cruzado, 
                             X = previsores,
                             y = vendas_global,
                             cv = 10,
